defmodule Flix.Protocol.Events.GetInfoResponse do
  defstruct [
    bluetooth_controller_state: Flix.Protocol.Enums.BluetoothControllerState.default(),
  ...
  def decode(
    ...
    verified_buttons =
      case nb_verified_buttons do
        0 -> []
        _n -> for << bd_addr::little-bytes-6 <- rest >>, do: Flix.Utils.bluetooth_address_from_binary(bd_addr)
      end
    ...
    %__MODULE__{
      ...
      no_space_for_new_connections: if(currently_no_space_for_new_connection == 0, do: false, else: true),
